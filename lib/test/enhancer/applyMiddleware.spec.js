...
test('insyn:enhancer:applyMiddleware - applies transformAction + transformResult', t => {
...
test('insyn:enhancer:applyMiddleware - single Middleware modifies result', t => {
...
test('insyn:enhancer:applyMiddleware - single middleware can call functions', t => {
    const spy = sinon.spy();
...
test('insyn:enhancer:applyMiddleware - multiple middlewares are called', t => {
    const spy = sinon.spy();
